...
namespace GerenciadorDeViagemApi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240127183716_updateconstraintap")]
    partial class updateconstraintap
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GerenciadorDeViagem.Model.Viagem", b =>
                {
                    ...
                    b.ToTable("Viagem", null, t =>
                        {
                            t.HasCheckConstraint("conts", "UsuarioSolicitanteMatricula != UsuarioAprovadorMatricula AND UsuarioAprovadorMatricula !=3131");
                        });
                });
