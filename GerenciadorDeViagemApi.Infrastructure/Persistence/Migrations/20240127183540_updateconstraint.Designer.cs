...
namespace GerenciadorDeViagemApi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240127183540_updateconstraint")]
            ...
            modelBuilder.Entity("GerenciadorDeViagem.Model.Viagem", b =>
                {
                    ...
                    b.ToTable("Viagem", null, t =>
                        {
                            t.HasCheckConstraint("conts", "UsuarioSolicitanteMatricula != UsuarioAprovadorMatricula or UsuarioAprovadorMatricula !=3131");
                        });
                });
